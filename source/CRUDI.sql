CREATE OR REPLACE PACKAGE BODY PC_Usuario AS
    ...
    END ModProductoEnCarritoCantidad;
...
CREATE OR REPLACE PACKAGE BODY PC_Direccion AS
...
CREATE OR REPLACE PACKAGE BODY PC_Producto AS
    ...
    BEGIN
        UPDATE Promociones
        SET fechaInicio = fechaInicio_
        WHERE idPromocion = idPromocion_;
    END ModPromocionFechaInicio;
    ...
    BEGIN
        UPDATE Promociones
        SET fechaFinal = fechaFin_
        WHERE idPromocion = idPromocion_;
    END ModPromocionFechaFin;
    ...
    BEGIN
        UPDATE Promociones
        SET descuentoPorcentaje = porcentajeDescuento
        WHERE idPromocion = idPromocion_;
    END ModPromocionPorcentajeDescuento;
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE BODY PC_Vendedor AS
