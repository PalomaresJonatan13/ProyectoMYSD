...
INSERT INTO Usuarios (
	email, nombres, apellidos, nombreUsuario, telefono, contrasena, tipoDoc, numeroDoc
)
VALUES (
	NULL,
	'Falla',
...
INSERT INTO Publicaciones (mensaje, fechaPublicacion) VALUES (
	'hola',
	SYSDATE
);
...
VALUES (
	1,
	'mi lista',
	TO_DATE('2020-01-01', 'YYYY-MM-DD'), -- El trigger sobrescribirá a SYSDATE
	TO_DATE('2020-01-01', 'YYYY-MM-DD')  -- El trigger sobrescribirá a SYSDATE
);
...
SET fechaCreacion = TO_DATE('2025-01-01', 'YYYY-MM-DD')
WHERE idLista = 2;
 ...
 */
INSERT INTO Usuarios (email, nombres, apellidos, nombreUsuario, telefono, contrasena, tipoDoc, numeroDoc, activo, fechaDesactivacion, fechaRegistro
) VALUES (
	TEmail('laura.gomez@empresa.com.co'),
	'Laura Sofia',
	'Gomez Rodriguez',
...
INSERT INTO Vendedores (usuario, verificado, nombreVendedor) VALUES (
	1,
	TBoolean('T'),
	'TiendaOficialA' 
);

INSERT INTO Productos (nombre, precio, cantidadInventario, cantidadDisponible, descripcion, fechaPublicacion, especificaciones, tiempoGarantia, estado, vendedor) VALUES (
	'Teclado Mecánico RGB',
	99.99,
	150,
	150,
...
INSERT INTO ProductosEnLista (lista, producto) VALUES (
	1,
	1
);
...
UPDATE DireccionesFavoritas
SET nombre = 'mi segunda house'
WHERE idDireccionFavorita = 1;
 ...
 *
 * Este trigger no lanza ningun error...
 */
 ...
 *
 * Trigger no lanza ninguna excepcion.
 */
...
UPDATE Seguimientos
SET fechaInicio = ADD_MONTHS(SYSDATE, -4)
 ...
 *
 * El trigger no lanza excepciones
 */
...
INSERT INTO Respuestas (publicacion, pregunta, modificada) VALUES (
	1,
	1,
	TBoolean('F')
);
