...
/*
 * Intervalo de tiempo mayor o igual a 3 meses.
 * (se calcula en dias)
 */
CREATE OR REPLACE TYPE TTiempoGarantia AS OBJECT (
	tiempoGarantia  NUMBER
);

/*
 * Número entero positivo menor o igual a 10
 */
...
/*
 * Cadena(256) que debe tener lo siguiente:
