-- Este script funciona si lo que se quiere eliminar son solo datos
-- sin una mayor relevancia, mas que todo fue para cumplir con el
-- requisito XPoblar, si se quiere hacer una limpieza total por favor
-- ejecutar Cleaner.sql
